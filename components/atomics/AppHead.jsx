...
const AppHead = ({ title, description, keyword, image }) => (
  <Head>
    ...
    <meta
      name="keywords"
      content={`Mohd Rashid Ansari, web developer, portfolio, frontend developer, web developer, frontend enginer, indonesia, portfolio, software enginer, ${keyword}`}
    />
